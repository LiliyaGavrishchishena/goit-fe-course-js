...
class Hamburger {
  ...
  /** Убрать topping, при условии, что она ранее была добавлена*/
    ...
    this.toppings.indexOf(topping) !== -1 ? this.toppings.splice(this.toppings.indexOf(topping), 1): this.toppings;
  }
  ...
  calculatePrice() {
    ...
    + (this.toppings.reduce((acc, topping) => acc + Hamburger.TOPPINGS[topping].price, 0));
  }
  ...
  calculateCalories() {
    return Hamburger.SIZES[this.size].calories +
           ...
           (this.toppings.reduce((acc, topping) => acc + Hamburger.TOPPINGS[topping].calories, 0));
  }
}
