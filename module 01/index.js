...
let numberOfSuits = prompt('Введите число необходмых мест');

if (numberOfSuits != Number.parseInt(numberOfSuits)) {
  alert ('Ошибка ввода');
} else {
  let answerAboutSuits;
  if (numberOfSuits <= taba) {
    answerAboutSuits = confirm ('Есть места в группе "taba". Вы согласны присоединиться к этой группе?');
    if (answerAboutSuits === true) {
      alert ('Приятного путешествия в группе "taba"');
    } else {
      alert ('Нам очень жаль, приходите еще!');
    }
  } else if (numberOfSuits <= sharm) {
    answerAboutSuits = confirm ('Есть места в группах: "sharm". Вы согласны присоединиться к этой группе?');
      if (answerAboutSuits === true) {
        alert ('Приятного путешествия в группе "sharm"');
      } else {
        alert ('Нам очень жаль, приходите еще!');
      }
  } else if (numberOfSuits <= hurgada) {
    answerAboutSuits = confirm ('Есть места в группе "hurgada". Вы согласны присоединиться к этой группе?');
    if (answerAboutSuits === true) {
